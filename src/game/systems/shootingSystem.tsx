...
export const handleShooting = (now: number, targetEnemy: Enemy | null, player: Player, playerWeapons: Weapon[]) => {
    const { 
        playerProjectiles, setPlayerProjectiles, lastPlayerShotTimestamp, setLastPlayerShotTimestamp 
    ...
    if (newlySpawnedProjectiles.length > 0) {
        setPlayerProjectiles([...playerProjectiles, ...newlySpawnedProjectiles]);
    }
